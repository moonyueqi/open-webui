...
_COL_KEYS = {
    ...
    # 阵风：优先「最大阵风风速」；可由调用方通过 gust_col 覆盖
    "gust": ["最大阵风风速", "最大瞬时风速", "极大风速", "最大风速"],
}
...
def read_obs_xlsx(
    ...
    *,
    ...
    gust_col_key：可选，指定阵风用列的关键字（如「最大阵风风速」「最大瞬时风速」），
