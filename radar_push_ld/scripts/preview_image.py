...
复用主程序的数据源与绘图逻辑：拉取"当前最新一帧 Z（2000m 反射率）实况"，渲染成
PNG 落盘到 state/ 目录（compose 已把 state 挂载到宿主机，便于直接查看/下载）。
...
from app.nc_reader import read_z  # noqa: E402
from app.plotter import render_radar_png  # noqa: E402
from app.radar_finder import find_latest_z  # noqa: E402
