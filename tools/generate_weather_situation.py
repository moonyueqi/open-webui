"""
title: 天气情况报告生成工具
description: 根据用户上传的"北京市降水预报图"，自动生成某区天气情况 Word 文档
author: lyq
version: 1.0.0
"""
...
class Tools:
    class Valves(BaseModel):
        template_path: str = Field(
            default=os.environ.get(
                "WEATHER_TEMPLATE_WEATHER_SITUATION",
                "/app/weather_templates/weather_situation/template.docx",
            ),
            description="天气情况 docx 模板的绝对路径",
        )
    ...
    async def generate_weather_situation(
        self,
        district: str,
        __user__: dict = None,
        ...
        """
        自动从 FTP 获取最新的北京市降水预报图，生成某区天气情况 Word 文档，并在聊天中提供下载。
