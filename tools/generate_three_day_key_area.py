"""
title: 未来三天气象服务专报生成器（首都关键区域）
description: 根据「北京市气象台 240h 精细化预报产品」自动生成首都关键区域气象服务保障中心
             所辖东城区 / 西城区 / 天安门地区的「未来三天气象服务专报」Word 文档
author: weather-tools
version: 1.0.0
license: MIT

【与 generate_three_day_forecast.py 的区别】
  1. 出件主体：首都关键区域气象服务保障中心；
  2. 服务对象：固定 3 个区域——东城区、西城区、天安门地区，工具入参用「东城/西城/天安门」即可，
     带不带「区」「地区」「天安门广场」等后缀都能识别；
  3. 文档版式：标题为「{area}天气预报」，第二段为「首都关键区域气象服务保障中心  yyyy年mm月dd日HH时」；
  4. 数据表列：日期 / 日期 / 天气 / 风向、风力 / 气温（℃） / 能见度（km），其中
     「能见度（km）」列因 240h 预报产品里没有相应字段，先整列留空；
  5. 数据来源仍是「北京市气象台 240h 精细化预报产品」，取 hour<=72 的前 6 个时次（3 天 × 白天/夜间）。
